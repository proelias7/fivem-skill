...
| Dynamic sleep, loops, payloads, tunnel_res, broadcast §1.6.1, StateBags §1.6.2, cache, client cache §2.1.1 | [performance.md](performance.md) |
| Audit passes §2.3–§2.5 | [audit-passes.md](audit-passes.md) |
